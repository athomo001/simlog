...
# grafana-zabbx-prtg
        'log_month': datetime.now().strftime('%b'),
        'log_day': datetime.now().strftime('%d'),
        'log_time': datetime.now().strftime('%H:%M:%S'),
        'kernel_timestamp': datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
        'hostname_linux': f"linux-host-{random.randint(1, 100)}",
        'disk_partition': random.choice(['/','/home','/var','/opt']),
        'disk_usage_percent': f"{random.randint(1,100)}%",
        'health_status_disk': random.choice(['OK','WARNING','CRITICAL']),
        'cpu_load_1min': f"{random.uniform(0,10):.2f}",
        'cpu_load_5min': f"{random.uniform(0,10):.2f}",
        'cpu_load_15min': f"{random.uniform(0,10):.2f}",
        'health_status_cpu': random.choice(['OK','WARNING','CRITICAL']),
        'ram_total_gb': str(random.randint(2,128)),
        'ram_used_gb': str(random.randint(1,128)),
        'ram_free_gb': str(random.randint(0,128)),
        'health_status_ram': random.choice(['OK','WARNING','CRITICAL']),
        'swap_total_gb': str(random.randint(1,64)),
        'swap_used_gb': str(random.randint(0,64)),
        'health_status_swap': random.choice(['OK','WARNING','CRITICAL']),
        'cpu_temp_c': str(random.randint(30,95)),
        'sys_temp_c': str(random.randint(25,90)),
        'health_status_temp': random.choice(['OK','WARNING','CRITICAL']),
        'active_processes': str(random.randint(50,500)),
        'health_status_proc': random.choice(['OK','WARNING','CRITICAL']),
        'cache_usage_percent': f"{random.randint(1,100)}%",
        'health_status_cache': random.choice(['OK','WARNING','CRITICAL']),
        'network_connections': str(random.randint(1,1000)),
        'health_status_net': random.choice(['OK','WARNING','CRITICAL']),
        'io_activity_status': random.choice(['Idle','Busy','High IO']),
        'health_status_io': random.choice(['OK','WARNING','CRITICAL']),
        'disk_partition_inodes': str(random.randint(100000,10000000)),
        'inodes_used_percent': f"{random.randint(1,100)}%",
        'health_status_inodes': random.choice(['OK','WARNING','CRITICAL']),
        'uptime_days': str(random.randint(1,365)),
        'health_status_uptime': random.choice(['OK','WARNING','CRITICAL']),
        'ntp_sync_status': random.choice(['Synchronized','Unsynchronized']),
        'health_status_ntp': random.choice(['OK','WARNING','CRITICAL']),
        'service_name_1': random.choice(['nginx','mysql','zabbix-agent','grafana-server','prtg-core']),
        'service_status_1': random.choice(['running','stopped','failed']),
        'health_status_service_1': random.choice(['OK','WARNING','CRITICAL']),
        'service_name_2': random.choice(['apache2','postgresql','zabbix-server','grafana-agent','prtg-probe']),
        'service_status_2': random.choice(['running','stopped','failed']),
        'health_status_service_2': random.choice(['OK','WARNING','CRITICAL']),
